...
@Component({
  selector: 'app-student-create-bill',
  templateUrl: './student-create-bill.component.html',
  styleUrls: ['./student-create-bill.component.scss']
})
export class StudentCreateBillComponent implements OnInit {
  studentId:number;
  billForm:FormGroup;
  semesters = [
    "فصل الخريف",
